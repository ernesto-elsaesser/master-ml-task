...
class FeedForwardNet:
    ...
    def export(self, filename = "trained.net"):
        with open(filename, 'w') as file:
            file.write(repr(self.in_to_hidden_weights).replace("\n", "") + "\n")
            file.write(repr(self.hidden_to_out_weights).replace("\n", "") + "\n")

    def import_(self, filename = "trained.net"):
        with open(filename, 'r') as file:
            self.in_to_hidden_weights = eval(file.readline())
            self.hidden_to_out_weights = eval(file.readline())
